...
export default function Navbar() {
  ...
  const links: NavLink[] = [
    ...
    // ❌ About dropdown removed
    { name: "About", href: "/about" },

    // 📦 Products dropdown (AUTO category)
    {
      name: "Products",
    ...
    >
      <div className="container-global px-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center space-x-8 text-[0.75rem] font-normal text-gray-800">
          ...
          {/* APPLY BUTTON */}
          <Link href="/apply">
            <Button className="text-[0.7rem] px-3 py-1">Apply</Button>
          </Link>
        </nav>
      ...
      <AnimatePresence>
        {mobileOpen && (
          ...
          >
            ...
            <Link href="/apply">
              <Button className="text-[0.75rem] px-3 py-1">Apply</Button>
            </Link>
          </motion.div>
        )}
      </AnimatePresence>
